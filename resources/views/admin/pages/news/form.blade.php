...
{{-- page title --}}
@section('title', $news->category_id ? __('admin.news-update') : 'admin.news-create')
        ...
        <div class="col s12 m12 12">
            <div id="basic-form" class="card card card-default scrollspy">
                <div class="card-content">
                    ...
                    <h4 class="card-title">{{$news->created_at ? __('admin.news-update') : __('admin.news-create')}}</h4>
                                ...
                                @foreach(config('translatable.locales') as $locale)
                                    <div id="lang-{{$locale}}" class="col s12  mt-5">
                                        <div class="input-field ">
                                            {!! Form::text($locale.'[title]',$news->translate($locale)->title ?? '',['class' => 'validate '. $errors->has($locale.'.title') ? '' : 'valid']) !!}
                                        ...
                                        <div class="input-field ">
                                            {!! Form::text($locale.'[date]',$news->translate($locale)->date ?? '',['class' => 'validate '. $errors->has($locale.'.date') ? '' : 'valid']) !!}
                                            {!! Form::label($locale.'[date]',__('admin.date')) !!}
                                            @error($locale.'.date')
                                            <small class="errorTxt4">
                                                <div class="error">
                                                    {{$message}}
                                        ...
                                        <div class="input-field ">
                                            {!! Form::text($locale.'[short_description]',$news->translate($locale)->short_description ?? '',['class' => 'validate '. $errors->has($locale.'.short_description') ? '' : 'valid']) !!}
                                        ...
                                        <div class="input-field ">
                                            {!! Form::text($locale.'[meta_title]',$news->translate($locale)->meta_title ?? '',['class' => 'validate '. $errors->has($locale.'.meta_title') ? '' : 'valid']) !!}
                                        ...
                                        <div class="input-field ">
                                            {!! Form::text($locale.'[meta_description]',$news->translate($locale)->meta_keyword ?? '',['class' => 'validate '. $errors->has($locale.'.meta_description') ? '' : 'valid']) !!}
                                        ...
                                        <div class="input-field ">
                                            {!! Form::text($locale.'[meta_keyword]',$news->translate($locale)->meta_description ?? '',['class' => 'validate '. $errors->has($locale.'.meta_keyword') ? '' : 'valid']) !!}
